...
class TestIsUrl(unittest.TestCase):
    ...
    def test_is_url_relative(self) -> None:
...
class TestGetFileTypeLabel(unittest.TestCase):
    ...
    def test_file_type_label_pdf(self) -> None:
        self.assertEqual(get_file_type_label(".pdf"), "PDF document")

    def test_file_type_label_png(self) -> None:
        self.assertEqual(get_file_type_label(".png"), "PNG image")

    def test_file_type_label_unknown(self) -> None:
