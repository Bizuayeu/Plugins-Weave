...
class TestLoadDisplayConfig:
    def test_returns_defaults_when_no_file(self) -> None:
        with patch("scripts.infrastructure.config_loader.read_json_safe", return_value=None):
    ...
    def test_reads_display_section(self) -> None:
        ...
        with patch("scripts.infrastructure.config_loader.read_json_safe", return_value=data):
            cfg = load_display_config()
