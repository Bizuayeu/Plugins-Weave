...
これまで述べた記憶定着は、経験を咀嚼して**足していく**営み——**足す夢**です。だが人間の睡眠が記憶を定着させるだけでなく、不要なシナプス結合を刈り込む（synaptic pruning）ように、健全な記憶には**引く夢**も要ります。

| 相 | 営み | 実装 |
|----|------|------|
| **足す夢** | 経験の咀嚼・統合・鮮度更新 | `/digest`（階層カスケード）＋ auto-memory の enrichment |
| **引く夢** | 重複の統合・陳腐の剪定・卒業 | `/dream-defrag`（auto-memory の GC） |

追記だけを続けると、記憶の索引はやがて「思い出す助け」から「ノイズ」へ転落します。引く夢は重複を統合し、上位層が定めるルールの再掲を削ぎ、完了した事項を降格させて、記憶を lean に保ちます。足すと引くの二相が揃って、はじめて記憶は健全に循環します。

> 📖 用語: [GLOSSARY.md - dream の二相](GLOSSARY.md#dream-の二相)
