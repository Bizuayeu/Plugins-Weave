...
class TestIsValidType:
    ...
    def test_valid_types_return_true(self, data, expected_type, expected_result):
        """正しい型の場合 True を返す"""
    ...
    def test_invalid_types_return_false(self, data, expected_type):
        """異なる型の場合 False を返す"""
        assert is_valid_type(data, expected_type) is False

    @pytest.mark.unit
    def test_subclass_returns_true(self):
...
class TestGetOrDefault:
    ...
    @pytest.mark.unit
    def test_returns_data_when_correct_type(self):
        """正しい型の場合はデータをそのまま返す"""
        data = {"key": "value"}
    ...
    @pytest.mark.unit
    def test_returns_default_when_wrong_type(self):
        """異なる型の場合はデフォルトを返す"""
        data = "not a dict"
        result = get_or_default(data, dict, dict)
        assert result == {}
...
class TestIsValidDict:
    ...
    def test_non_dict_returns_false(self, non_dict_value):
        """dict 以外は False"""
        assert is_valid_dict(non_dict_value) is False

    @pytest.mark.unit
    def test_typeguard_narrows_type(self):
...
class TestIsValidList:
    ...
    def test_non_list_returns_false(self, non_list_value):
        """list 以外は False"""
...
class TestIsValidStr:
    ...
    @pytest.mark.unit
    def test_str_returns_true(self):
        """str は True"""
    ...
    def test_non_str_returns_false(self, non_str_value):
        """str 以外は False"""
...
class TestIsValidInt:
    ...
    def test_non_int_returns_false(self, non_int_value):
        """int 以外は False"""
...
class TestGetListOrEmpty:
    ...
    @pytest.mark.unit
    def test_tuple_returns_empty_list(self):
...
class TestGetStrOrEmpty:
    ...
    @pytest.mark.unit
    def test_str_returns_same_str(self):
        """str を渡すとそのまま返す"""
        data = "hello"
    ...
    @pytest.mark.unit
    def test_non_str_returns_empty_str(self):
        """str 以外を渡すと空文字列を返す"""
    ...
    @pytest.mark.unit
    def test_empty_str_returns_empty_str(self):
        """空文字列を渡すと空文字列を返す"""
