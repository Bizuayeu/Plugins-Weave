...
class TestExtractLongValue:
    ...
    def test_returns_default_for_non_dict_non_string(self):
    ...
    def test_handles_empty_long_value(self):
...
class TestExtractValue:
    ...
    def test_extracts_any_key(self):
        """任意のキーで値を抽出"""
