...
class TestFilePatterns:
    ...
    @pytest.mark.unit
    def test_loop_file_pattern(self):
    ...
    @pytest.mark.unit
    def test_weekly_file_pattern(self):
...
class TestConstantsConsistency:
    ...
    @pytest.mark.unit
    def test_template_names_are_distinct_from_filenames(self):
        """テンプレート名と実ファイル名が異なる"""
