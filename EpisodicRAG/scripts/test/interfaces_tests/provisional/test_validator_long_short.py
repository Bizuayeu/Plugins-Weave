...
class TestValidateLongShortText:
    ...
    def test_valid_long_short_format(self):
...
class TestValidateIndividualDigestLongShort:
    ...
    def test_valid_digest_with_long_short(self):
    ...
    def test_string_abstract_rejected(self):
    ...
    def test_string_impression_rejected(self):
    ...
    def test_missing_abstract_allowed(self):
    ...
    def test_missing_impression_allowed(self):
