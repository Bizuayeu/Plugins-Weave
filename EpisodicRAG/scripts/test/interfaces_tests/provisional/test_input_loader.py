...
class TestInputLoaderLoadFromString(unittest.TestCase):
    ...
    def test_load_valid_list_string(self) -> None:
    ...
    def test_load_valid_dict_string(self) -> None:
    ...
    def test_load_empty_list_string(self) -> None:
    ...
    def test_load_empty_input_raises_error(self) -> None:
    ...
    def test_load_whitespace_only_raises_error(self) -> None:
    ...
    def test_load_json_without_individual_digests_key(self) -> None:
    ...
    def test_load_json_string_not_object(self) -> None:
    ...
    def test_load_json_number(self) -> None:
...
class TestInputLoaderLoadFromFile(unittest.TestCase):
    ...
    def test_load_valid_list_file(self) -> None:
    ...
    def test_load_valid_dict_file(self) -> None:
    ...
    def test_load_nonexistent_file_parses_as_json(self) -> None:
    ...
    def test_load_file_unicode_content(self) -> None:
...
class TestInputLoaderEdgeCases(unittest.TestCase):
    ...
    def test_load_with_trailing_whitespace(self) -> None:
    ...
    def test_load_with_leading_whitespace(self) -> None:
