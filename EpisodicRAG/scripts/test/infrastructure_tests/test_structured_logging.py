...
class TestStructuredLoggerFileOp:
    ...
    @pytest.mark.unit
    def test_file_op_prefix_format(
        self, logger: StructuredLogger, caplog: pytest.LogCaptureFixture
    ) -> None:
...
class TestStructuredLoggerValidation:
    ...
    @pytest.mark.unit
    def test_validation_message_only(
        self, logger: StructuredLogger, caplog: pytest.LogCaptureFixture
    ) -> None:
        """メッセージのみの検証ログ"""
        with caplog.at_level(logging.DEBUG, logger="episodic_rag"):
    ...
    @pytest.mark.unit
    def test_validation_prefix_format(
        self, logger: StructuredLogger, caplog: pytest.LogCaptureFixture
    ) -> None:
...
class TestStructuredLoggerDecision:
    ...
    @pytest.mark.unit
    def test_decision_message_only(
        self, logger: StructuredLogger, caplog: pytest.LogCaptureFixture
    ) -> None:
        """メッセージのみの判断ログ"""
        with caplog.at_level(logging.DEBUG, logger="episodic_rag"):
    ...
    @pytest.mark.unit
    def test_decision_prefix_format(
        self, logger: StructuredLogger, caplog: pytest.LogCaptureFixture
    ) -> None:
