...
class TestGetSourceDir:
    ...
    def test_weekly_returns_loops_path(self, temp_plugin_env) -> None:
    ...
    def test_monthly_returns_weekly_dir(self, temp_plugin_env) -> None:
    ...
    def test_quarterly_returns_monthly_dir(self, temp_plugin_env) -> None:
    ...
    def test_annual_returns_quarterly_dir(self, temp_plugin_env) -> None:
    ...
    def test_all_levels_return_valid_paths(self, temp_plugin_env) -> None:
    ...
    def test_invalid_level_raises_error(self, temp_plugin_env) -> None:
...
class TestGetSourcePattern:
    ...
    def test_weekly_returns_loop_pattern(self, temp_plugin_env) -> None:
    ...
    def test_monthly_returns_weekly_pattern(self, temp_plugin_env) -> None:
    ...
    def test_quarterly_returns_monthly_pattern(self, temp_plugin_env) -> None:
    ...
    def test_multi_decadal_returns_decadal_pattern(self, temp_plugin_env) -> None:
    ...
    def test_centurial_returns_multi_decadal_pattern(self, temp_plugin_env) -> None:
...
class TestSourcePathIntegration:
    ...
    def test_source_dir_and_pattern_consistency(self, temp_plugin_env) -> None:
