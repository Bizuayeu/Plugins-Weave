...
class TestMarkdownLinkChecker:
    ...
    def test_valid_relative_link(self, temp_docs_dir):
        """有効な相対リンクの検出"""
        # Setup
    ...
    def test_broken_link_detection(self, temp_docs_dir):
        """壊れたリンクの検出"""
        # Setup
        file1 = temp_docs_dir / "index.md"
    ...
    def test_anchor_validation_valid(self, temp_docs_dir):
        """有効なアンカーリンクの検証"""
        # Setup
        file1 = temp_docs_dir / "index.md"
        file1.write_text(
    ...
    def test_anchor_validation_missing(self, temp_docs_dir):
        """存在しないアンカーの検出"""
        # Setup
        file1 = temp_docs_dir / "index.md"
    ...
    def test_file_with_anchor(self, temp_docs_dir):
        """ファイル+アンカーの複合検証"""
        # Setup
        file1 = temp_docs_dir / "index.md"
        file2 = temp_docs_dir / "guide.md"
    ...
    def test_nested_directory_resolution(self, temp_docs_dir):
        """ネストしたディレクトリのリンク解決"""
        # Setup
    ...
    def test_parent_directory_link(self, temp_docs_dir):
        """親ディレクトリへのリンク解決"""
        # Setup
        subdir = temp_docs_dir / "dev"
        subdir.mkdir()
    ...
    def test_external_link_skip(self, temp_docs_dir):
    ...
    def test_summary_generation(self, temp_docs_dir):
        """サマリー生成"""
        # Setup
        file1 = temp_docs_dir / "index.md"
        file2 = temp_docs_dir / "guide.md"
    ...
    def test_get_broken_links(self, temp_docs_dir):
        """壊れたリンクのみ取得"""
        # Setup
        file1 = temp_docs_dir / "index.md"
        file1.write_text(
    ...
    def test_japanese_heading_anchor(self, temp_docs_dir):
        """日本語見出しのアンカー検証"""
        # Setup
        file1 = temp_docs_dir / "index.md"
        file1.write_text(
    ...
    def test_multiple_links_in_one_line(self, temp_docs_dir):
        """1行に複数のリンク"""
        # Setup
        file1 = temp_docs_dir / "index.md"
    ...
    def test_link_check_result_to_dict(self, temp_docs_dir):
