...
class TestGetShadowDigestForLevel:
    ...
    def test_returns_digest_when_exists(
        self, cascade_processor, temp_plugin_env: "TempPluginEnvironment"
    ) -> None:
...
class TestPromoteShadowToGrand:
    ...
    @pytest.mark.integration
    def test_logs_ready_for_promotion(
...
class TestCascadeUpdateOnDigestFinalize:
    ...
    @pytest.mark.integration
    def test_cascade_logs_start_and_end(
        self, cascade_processor, caplog: pytest.LogCaptureFixture
    ) -> None:
        """カスケード処理の開始・終了をログ出力"""
    ...
    @pytest.mark.integration
    def test_cascade_centurial_logs_top_level(
        self, cascade_processor, caplog: pytest.LogCaptureFixture
    ) -> None:
...
class TestCascadeProcessorEdgeCases:
    ...
    @pytest.mark.integration
    def test_cascade_multiple_levels_sequentially(
        self, cascade_processor, caplog: pytest.LogCaptureFixture
    ) -> None:
        """複数レベルを順次カスケード処理"""
...
class TestGetShadowDigestTypeChecks:
    ...
    @pytest.mark.unit
    def test_get_shadow_digest_with_string_overall_digest(
        self, cascade_processor, caplog: pytest.LogCaptureFixture
    ) -> None:
    ...
    @pytest.mark.unit
    def test_get_shadow_digest_with_none(
        self, cascade_processor, caplog: pytest.LogCaptureFixture
    ) -> None:
    ...
    @pytest.mark.unit
    def test_get_shadow_digest_with_invalid_type(
        self, cascade_processor, caplog: pytest.LogCaptureFixture
    ) -> None:
    ...
    @pytest.mark.unit
    def test_promote_with_invalid_overall_digest(
        self, cascade_processor, caplog: pytest.LogCaptureFixture
    ) -> None:
