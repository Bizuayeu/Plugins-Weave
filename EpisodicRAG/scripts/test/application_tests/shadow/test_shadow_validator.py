...
class TestShadowValidatorNonConsecutiveFiles:
    ...
    @pytest.mark.unit
    def test_non_consecutive_files_user_continues(
    ...
    @pytest.mark.unit
    def test_non_consecutive_files_user_cancels(
        self, validator, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    @pytest.mark.unit
    def test_non_consecutive_files_user_empty_input_cancels(
        self, validator, monkeypatch: pytest.MonkeyPatch
    ) -> None:
...
class TestShadowValidatorConfirmCallback:
    ...
    @pytest.mark.unit
    def test_non_consecutive_cancelled_via_callback(
    ...
    @pytest.mark.unit
    def test_non_consecutive_continued_via_callback(
        self, shadow_manager: "ShadowGrandDigestManager"
    ) -> None:
        """コールバックで承認時に正常に継続される"""
        # 常に承認するコールバック
