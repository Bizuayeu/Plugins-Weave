...
class TestFileNumberValidatorInit:
    ...
    def test_init_with_default_dependencies(self) -> None:
        """デフォルト依存関係で初期化"""
...
class TestExtractNumbers:
    ...
    def test_valid_loop_filenames(self, validator) -> None:
        """有効なLoopファイル名から番号を抽出"""
    ...
    def test_valid_weekly_filenames(self, validator) -> None:
    ...
    def test_valid_monthly_filenames(self, validator) -> None:
    ...
    def test_single_filename(self, validator) -> None:
        """単一ファイル名から番号を抽出"""
    ...
    def test_empty_filenames(self, validator) -> None:
        """空のリストでもエラーなし"""
    ...
    def test_non_string_filename_returns_error(self, validator, invalid_type) -> None:
        """文字列以外のファイル名はエラーを返す"""
    ...
    def test_non_string_in_middle_of_list(self, validator) -> None:
        """リスト中間の非文字列要素もエラー"""
    ...
    def test_invalid_filename_format_returns_error(self, validator) -> None:
    ...
    def test_no_prefix_returns_error(self, validator) -> None:
        """プレフィックスがないファイル名はエラー"""
    ...
    def test_no_number_returns_error(self, validator) -> None:
        """番号がないファイル名はエラー"""
    ...
    def test_mixed_valid_invalid_returns_partial_results(self, validator) -> None:
    ...
    def test_all_invalid_returns_empty_numbers(self, validator) -> None:
        """全て無効な場合は空の番号リストを返す"""
    ...
    def test_error_accumulation(self, validator) -> None:
        """複数のエラーが蓄積される"""
...
class TestCheckConsecutive:
    ...
    def test_consecutive_numbers_return_true(self, validator, numbers) -> None:
        """連番はTrueを返す"""
    ...
    def test_non_consecutive_numbers_return_false(self, validator, numbers) -> None:
        """非連番はFalseを返す"""
    ...
    def test_unsorted_consecutive_returns_true(self, validator) -> None:
        """未ソートの連番もTrueを返す"""
        assert validator.check_consecutive([3, 1, 2]) is True
        assert validator.check_consecutive([5, 3, 4]) is True

    def test_unsorted_non_consecutive_returns_false(self, validator) -> None:
        """未ソートの非連番もFalseを返す"""
    ...
    def test_single_element_is_consecutive(self, validator) -> None:
        """1要素は連番とみなす"""
        assert validator.check_consecutive([1]) is True
        assert validator.check_consecutive([999]) is True

    def test_empty_list_is_consecutive(self, validator) -> None:
        """空リストは連番とみなす"""
        assert validator.check_consecutive([]) is True

    def test_duplicate_numbers_are_not_consecutive(self, validator) -> None:
        """重複番号は連番ではない"""
        assert validator.check_consecutive([1, 1, 2]) is False
        assert validator.check_consecutive([1, 2, 2, 3]) is False

    def test_large_consecutive_sequence(self, validator) -> None:
        """大きな連番シーケンス"""
        numbers = list(range(1, 1001))  # 1-1000
        assert validator.check_consecutive(numbers) is True

    def test_negative_numbers(self, validator) -> None:
        """負の数も連番として処理"""
...
class TestValidateConsecutive:
    ...
    def test_consecutive_returns_empty_warnings(self, validator) -> None:
        """連番は警告なし"""
    ...
    def test_empty_numbers_returns_empty_warnings(self, validator) -> None:
        """空の番号リストは警告なし"""
        warnings = validator.validate_consecutive([], [])
        assert warnings == []

    def test_single_number_returns_empty_warnings(self, validator) -> None:
        """単一番号は警告なし"""
...
class TestFileNumberValidatorEdgeCases:
    ...
    def test_unicode_suffix_in_filename(self, validator) -> None:
        """日本語サフィックスを含むファイル名"""
    ...
    def test_emoji_in_filename_suffix(self, validator) -> None:
        """絵文字を含むファイル名"""
    ...
    def test_min_file_number(self, validator) -> None:
        """最小ファイル番号（1）"""
        filenames = ["L00001_test.txt"]
        numbers, errors = validator.extract_numbers(filenames)
    ...
    def test_max_file_number(self, validator) -> None:
        """大きなファイル番号（99999）"""
    ...
    def test_filename_with_multiple_underscores(self, validator) -> None:
        """複数のアンダースコアを含むファイル名"""
    ...
    def test_filename_with_numbers_in_suffix(self, validator) -> None:
        """サフィックスに数字を含むファイル名"""
    ...
    def test_different_level_prefixes_in_same_list(self, validator) -> None:
        """異なるレベルプレフィックスが混在"""
    ...
    def test_quarterly_filenames(self, validator) -> None:
        """Quarterlyファイル名"""
    ...
    def test_annual_filenames(self, validator) -> None:
        """Annualファイル名"""
    ...
    def test_error_index_is_correct(self, validator) -> None:
    ...
    def test_multiple_error_indices(self, validator) -> None:
        """複数のエラーインデックス"""
